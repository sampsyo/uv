...
//     use crate::marker::{
//         parse, MarkerExpressionKind, MarkerOperator, MarkerTree, MarkerValueString,
//         MarkerValueVersion,
//     };
...
//                 .collect(),
//             )),
//             marker: Some(MarkerTree::Expression(MarkerExpressionKind::Version {
...
//             MarkerTree::Expression(MarkerExpressionKind::Version {
//                 key: MarkerValueVersion::PythonVersion,
//                 specifier: VersionSpecifier::from_pattern(
...
//             }),
//             MarkerTree::Or(vec![
//                 MarkerTree::Expression(MarkerExpressionKind::String {
